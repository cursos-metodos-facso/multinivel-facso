...
Se recomienda utilizar bases de datos con una estructura clara de al menos dos niveles, como las comparativas internacionales, o nacionales que puedan identificar comunas, o educacionales que puedan identificar colegios/salas. Se pueden revisar algunas bases de datos de la sección de recursos [acá](/resource/#bases-de-datos)
...
**Formato**: Idealmente en formato html/(R)Markdown/Quarto.
...
Las presentaciones son breves, máximo 10 minutos y luego 5 a 10 minutos de preguntas, comentarios y sugerencias. Se debe elaborar un documento a proyectar que acompañe la presentación, máximo 10 láminas. No es necesario que presenten todos los integrantes del grupo, pero sí todos deben estar disponibles para responder preguntas. La asistencia a las presentaciones es obligatoria.
...
- Se entrega documento de trabajo y también código de análisis en formato (R)Markdown.
...
Las entregas y revisiones de trabajos del curso operarán en la plataforma Github Classroom. Esto nos permitirá una revisión más apropiada del código y de los contenidos de los trabajos, y dar retroalimentación más específica a cada grupo. Se puede acceder a un tutorial [aquí](/assignment/classroom.html). Incluye un video al final.

# Github Desktop

Si bien es posible utilizar Github desde RStudio, existen mejores herramientas para esto. La más usada es Github Desktop, se recomienda. Acá un un [tutorial](/assignment/desktop.html). 

# Presentaciones de trabajos

- Al final de semestre cada grupo presenta su trabajo.
- La asistencia a la sesión de presentaciones es **obligatoria**
- Cada presentación  será de 15 minutos + 10 de preguntas. 
- En la página de prácticos hay una [guía para hacer la presentación en Quarto](/assignment/quarto-presentations.html) (no es obligación hacerla en este formato).
- El documento de presentación o link correspondiente debe ser enviado antes de que comience la sesión de presentaciones
- Se sugiere que presenten máximo 2 personas, y quienes no presentan responden preferentemente las preguntas.

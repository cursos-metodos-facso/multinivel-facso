...
-   La estimación .red[sin centrar] en algunos casos puede llevar a algunos .blue[problemas en la interpretación] de los parámetros del modelo

-   El centrado se implementa .green[restando una constante] del predictor (usualmente el promedio)
...
.center[
![:scale 60%](images/plot3.jpeg)
]
---
### Ejemplo centrado en regresión simple -centrado en 100

.center[
![:scale 60%](images/plot4.jpeg)
]
---
...
(Acceso [aquí](https://multinivel.netlify.app/readings/enderstofighi.pdf))
---
...
-   Tomando como referencia .blue[dos niveles], el centrado de los predictores de nivel uno puede tomar 2 formas principales: 
      - a la gran media o promedio general (**CGM** - centered grand mean)
      
      - al promedio al interior (within) de
    grupos/clusters (**CWC** - centered within clusters) 
    
.right[.small[(nomenclatura Enders & Tofighi, 2007)]]

---
# Distintos centrados según nivel

- El **CGM** (a la gran media) es equivalente al de regresión simple para el mismo propósito: se resta el valor del .red[promedio general]

-   En el **CWC** (a la media grupal) se resta el .red[promedio del grupo] (es decir, para cada grupo) en lugar de la gran media
...
.center[
## _Which form of centering provides interpretable parameter estimates that can be used to address a particular   substantive research question?_ 
...
## A diferencia del centrado a la gran media (que altera el valor del intercepto), el .red[centrado al grupo] cambia la estructura de la variable, y afecta tanto al beta como al intercepto


---
.center[
![:scale 60%](images/tab1.JPG)
]
